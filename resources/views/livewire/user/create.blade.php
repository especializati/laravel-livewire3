<div wire:keydown.document.escape="actionDocument" wire:resize.window="actionResize">
    <form>
        ...
        <div class="text-center pt-1 mb-5 pb-1">
            <button wire:click="resetar" class="btn btn-warning btn-block fa-lg gradient-custom-2 mb-3"
                type="button">Log
                in</button>
        ...
        <div class="d-flex align-items-center justify-content-center pb-4">
            ...
            <button type="button" class="btn btn-warning gradient-custom-2"
                wire:click.debounce.2000ms="actionClick()">Criar
                Nova</button>
        </div>
